...
class _ModernLoginScreenState extends ConsumerState<ModernLoginScreen>
  ...
  Future<void> _signInWithEmail() async {
    ...
    try {
      ...
      if (_isRegisterMode) {
        ...
        if (mounted) _showSnackBar('Login successful!', Colors.green);
      }
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      if (result != null) {
        if (mounted) _showSnackBar('Google sign-in successful!', Colors.green);
        ref.invalidate(authStateProvider);
      }
    } catch (e) {
      ...
      if (mounted) _showSnackBar(errorMessage, Colors.orange);
    } finally {
      if (mounted) {
        ref.read(authLoadingProvider.notifier).state = false;
      }
  ...
  Future<void> _signInWithBiometric() async {
    try {
      ...
      if (result != null) {
        if (mounted) _showSnackBar('Biometric authentication successful!', Colors.green);
        ref.invalidate(authStateProvider);
      }
    } catch (e) {
  ...
  Future<void> _enableBiometric() async {
    try {
      ...
      if (mounted) _showSnackBar('Biometric authentication enabled!', Colors.green);
    } catch (e) {
