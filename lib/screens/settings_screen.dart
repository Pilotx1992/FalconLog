...
// BACKUP SYSTEM REMOVED - Will be replaced with new WhatsApp-style backup system
...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSettingsCard([
                    ...
                    //         ref.watch(autoBackupEnabledProvider);
                    //     final backupProvider =
                    //         ref.watch(backupProviderProvider);
                    //     final lastBackupAsync =
                    //         ref.watch(lastBackupTimeProvider);
                    //     final backupStatus = ref.watch(backupStatusProvider);
                    //     final backupRecommendation =
                    //         ref.watch(backupRecommendationProvider);
                    ...
                    //         data: (history) =>
                    //             '${history.length} backups available',
                    //         loading: () => 'Loading...',
                    ...
                    //   title: 'Military-Grade Backup',
                    //   subtitle: 'Advanced backup with military-grade encryption',
                    //   onTap: () => _navigateToAdvancedBackup(),
                    // ),
                    _buildSettingsTile(
                      icon: Icons.backup_rounded,
                      title: 'Backup Settings',
                      subtitle: 'Manage your flight log backups',
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
  ...
  // BACKUP METHODS COMMENTED OUT - Will be replaced with new WhatsApp-style backup system
  ...
  void _navigateToAdvancedBackup() {
    if (!mounted) return;
    Navigator.of(context).push(
      MaterialPageRoute(
  ...
  String _getBackupSubtitle(BackupStatus status,
      BackupRecommendation recommendation, DateTime? lastBackup) {
    ...
    if (recommendation.toString().contains('Disabled')) {
      return 'Auto backup is disabled';
    }
    if (recommendation.toString().contains('FirstBackup')) {
      return 'Create your first backup to secure your data';
    }
    if (recommendation.toString().contains('Overdue')) {
      return 'Backup overdue - action needed';
    }
    if (recommendation.toString().contains('Recommended')) {
      return 'Backup recommended';
    }
    if (recommendation.toString().contains('Offline')) {
      return 'Offline - Local backup only';
    }
    ...
    if (recommendation.toString().contains('Loading')) {
      return 'Checking backup status...';
    }
    if (recommendation.toString().contains('Error')) {
      return 'Error checking backup status';
    }
