...
class KeyFileFormatNew {
  ...
  factory KeyFileFormatNew.fromKey({
  ...
  /// Create from JSON
  factory KeyFileFormatNew.fromJson(Map<String, dynamic> json) =>
      KeyFileFormatNew(
